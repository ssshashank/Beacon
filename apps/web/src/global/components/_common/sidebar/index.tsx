  ...
  return (
    <>
      <aside class="w-0 md:w-[400px] h-[calc(100vh-30px)] flex flex-col md:flex-row md:h-[calc(100vh-20px)]">
        <div class="fixed bottom-10 rounded-md left-0 w-fit mx-auto right-0 z-50 h-fit flex flex-row items-center bg-gray-800/30 justify-center p-1 border-r-[0.03px] border-neutral-500 backdrop-blur-lg
          md:relative md:top-0 md:bottom-0 md:bg-transparent md:w-[60px] md:flex-col md:justify-start md:h-full md:border-r-[0.03px] md:border-r-[0.03px] md:border-neutral-700 md:rounded-none md:px-0">
